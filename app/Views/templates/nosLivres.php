...
<section class="nosLivres-section">
    <div class="nosLivres-section__header">
        ...
        <form method="POST" action="/nos-livres" class="champs-recherche">
            <button type="submit" class="champs-recherche__button"><i class="fa-solid fa-magnifying-glass"></i></button>
            <input type="text" name="rechercheLivre" placeholder="Rechercher un livre" class="champs-recherche__input" value="<?= isset($_POST["rechercheLivre"]) ? htmlspecialchars($_POST["rechercheLivre"], ENT_QUOTES, 'UTF-8') : "" ?>">
        </form>
    </div>
